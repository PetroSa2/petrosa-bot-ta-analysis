"""
Tests for the Liquidity Grab Reversal strategy.
"""
...
class TestLiquidityGrabReversalStrategy:
    """Test cases for LiquidityGrabReversalStrategy."""
    ...
    def test_analyze_with_valid_data(self, sample_data, sample_indicators):
        ...
        if signal:
            ...
            assert signal.strategy_id == "liquidity_grab_reversal"
    ...
    def test_analyze_no_liquidity_grab_pattern(self, sample_data):
        ...
        strategy = LiquidityGrabReversalStrategy()
        # Price not near lower band
        df = pd.DataFrame(
            {
                "open": [100, 101, 102, 103, 104],
                "high": [105, 106, 107, 108, 109],
                "low": [95, 96, 97, 98, 99],
                "close": [102, 103, 104, 105, 106],  # Not near lower band
                "volume": [1000, 1100, 1200, 1300, 1400],
            }
        )

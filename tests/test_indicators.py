...
class TestIndicators:
    ...
    def test_rsi_insufficient_data(self):
        ...
        df = pd.DataFrame({
            'close': [100, 101, 102]  # Less than 14 periods
        })
    ...
    def test_macd_insufficient_data(self):
        ...
        df = pd.DataFrame({
            'close': [100, 101, 102]  # Less than 26 periods
        })
    ...
    def test_bollinger_bands_insufficient_data(self):
        ...
        df = pd.DataFrame({
            'close': [100, 101, 102]  # Less than 20 periods
        })
    ...
    def test_is_inside_candle_basic(self):
        ...
        df = pd.DataFrame({
            'high': [105, 104, 106],  # Second candle inside first
            'low': [95, 96, 94]
        })

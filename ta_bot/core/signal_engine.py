...
class SignalEngine:
    ...
    def analyze_candles(self, df: pd.DataFrame, symbol: str, period: str) -> List[Signal]:
        ...
        try:
            ...
            if len(df) < 50:
                logger.warning(f"Insufficient data for {symbol} {period}: {len(df)} candles")
                return signals
            ...
            for strategy_name, strategy in self.strategies.items():
                try:
                    ...
                    if signal:
                        ...
                        logger.info(f"Signal generated: {strategy_name} for {symbol} {period}")
    ...
    def _calculate_indicators(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        indicators['macd'], indicators['macd_signal'], indicators['macd_hist'] = self.indicators.macd(df)
        ...
        # Bollinger Bands
        indicators['bb_lower'], indicators['bb_middle'], indicators['bb_upper'] = self.indicators.bollinger_bands(df)
    ...
    def _run_strategy(
        ...
        try:
            ...
            confidence = ConfidenceCalculator.calculate_confidence(strategy_name, df, metadata)

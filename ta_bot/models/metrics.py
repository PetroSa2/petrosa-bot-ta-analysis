...
class PerformanceMetricsData(BaseModel):
    ...
    resource_usage: ResourceUsageMetrics | None = None
...
class ResourceMetrics(BaseModel):
    ...
    limit: str | None = Field(None, description="Resource limit (if applicable)")
...
class MemoryMetrics(BaseModel):
    ...
    limit_mb: int | None = Field(None, description="Memory limit in MB")
